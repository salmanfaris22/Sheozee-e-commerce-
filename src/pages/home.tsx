  ...
  return (
    <div className="mt-[80px]">
     ...
     <div
      ...
      >
        <div className='flex p-4 flex-col justify-center items-center text-center md:text-left bg-black bg-opacity-0 hover:bg-opacity-50 rounded-lg transition-all duration-300'>
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-4'>
            <MyButton
              ...
              type={"button"}
              className={"px-4 py-2 bg-white text-black font-semibold rounded-md transition-all duration-300 transform hover:scale-105 hover:bg-gray-800 hover:text-white"}
            />
            <MyButton
              label={"Shop Now"}

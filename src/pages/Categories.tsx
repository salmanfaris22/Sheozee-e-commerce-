          ...
          <div key={index} data-aos="flip-left">
              ...
              <div className="relative h-[300px] bg-white shadow-md rounded-lg overflow-hidden group">
                ...
                <div className="items-center justify-center group-hover:opacity-100 transition-opacity duration-300">
                    <MyButton label={category.name}onClick={()=>console.log("sum")}  type={"button"} className={"text-white hover:bg-white hover:text-black bg-black p-3 rounded-md w-full"}/>
                </div>
                </div>
              </div>
              <div className="mt-2">
                <div className="items-center justify-center group-hover:opacity-100 transition-opacity duration-300">
                    <MyButton label={category.name}onClick={()=>console.log("sum")}  type={"button"} className={"text-white bg-black p-3 rounded-md w-full"}/>
                </div>
              </div>

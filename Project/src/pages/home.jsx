  ...
  return (
    <div className="mt-[80px] bg-white text-black min-h-screen">
      <div className="p-4">
        ...
        >
          <div className="flex p-4 flex-col justify-center items-center text-center md:text-left bg-opacity-70 rounded-lg transition-all duration-300">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-black drop-shadow-lg">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-4">
              <MyButton
                ...
                type={"button"}
                className="px-4 py-2 bg-blue-500 text-white font-semibold rounded-md transition-all duration-300 transform hover:scale-105 hover:bg-blue-600"
              />
              <MyButton
                label={"Shop Now"}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full p-4">
        {/* Main Image Section */}
        <div className="relative group overflow-hidden rounded-lg shadow-lg bg-gray-100">
